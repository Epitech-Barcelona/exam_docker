...
docker run --rm -v "$GIT_CONFIG_SRC:$GIT_CONFIG_DEST" -v "$SOURCE_FOLDER:$DEST_FOLDER" -it $DOCKER_IMAGE /bin/bash -c "chown student.student /home/student && git clone https://github.com/Epitech-Barcelona/exam_tek1.git && mv exam_tek1 /home/student/subject && su - student"
